...
def test_add_user_success(db_session):
    ...
    result = user_repo.add_user(username, password, email, first_name, last_name, mobile, address)
...
def test_add_user_failure_due_to_duplicate_username(db_session):
    ...
    first_result = user_repo.add_user(username, password, email, first_name, last_name, mobile, address)
...
def test_authenticate_user_success(db_session):
    ...
    authentication_successful = user_repo.authenticate_user("test_user", "secure_password")
...
def test_update_basic_user_info_all_args_success(db_session):
    ...
    updated = user_repo.update_basic_user_info("test_user", address="1010 test update st", email="datesting@gmail.com", mobile="0987654321")
...
def test_update_basic_user_info_some_args_success(db_session):
    user_repo = quick_add_test_user()
    pre_manipulated_user_data = db_session.query(User).filter_by(username="test_user").first()
    
    updated = user_repo.update_basic_user_info("test_user", address="1010 test update st", email="datesting@gmail.com")
...
def test_update_basic_user_info_all_args_failure(db_session):
    ...
    updated = user_repo.update_basic_user_info("test_userr", "1010 test update st", "datesting@gmail.com", "0987654321")
...
def test_change_username_success_with_username(db_session):
    ...
    assert user_repo.change_username(new_username="new_username",old_username="test_user") is True
